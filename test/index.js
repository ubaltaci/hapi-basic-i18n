    ...
    it("returns valid localized strings for EN", function (done) {
        server.register({
                ...
                config: {
                    handler: function (request, reply) {
                        ...
                        var localized = {
                            ...
                            say_hello_to: request.i18n("Say Hello To", "Cagdas"),
            ...
            server.inject("/", function (res) {
                ...
                expect(localized.say_hello_to).to.equal("Hello Cagdas!");
    ...
    it("returns valid localized strings for TR", function (done) {
        server.register({
            ...
            server.inject("/", function (res) {
                ...
                expect(localized.say_hello_to).to.equal("Selam Cagdas!");
    ...
    it("returns ..", function (done) {
        ...
        server.register({
            ...
            server.inject("/", function (res) {
                ...
                expect(tokens[3]).to.equal("Hello Cagdas!");
                done();
            });
        });
    });
